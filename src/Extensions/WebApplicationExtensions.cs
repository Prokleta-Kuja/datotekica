...
public static class WebApplicationExtensions
{
    ...
    {
        app.MapGet(C.Routes.DownloadPattern, async (Guid id, CacheService cache, HttpContext ctx) => await Download(id, cache, ctx, false));
        app.MapGet(C.Routes.AttachmentPattern, (Guid id, CacheService cache, HttpContext ctx) => Download(id, cache, ctx, true));
    }
    static async Task Download(Guid id, CacheService cache, HttpContext ctx, bool isAttachment)
    {
